...
export default function AdminPanel() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased flex">
      <aside className="w-64 bg-slate-900 text-slate-300 border-r border-slate-800 hidden md:flex flex-col justify-between p-6">
        <div>
          <div className="flex items-center gap-2 mb-8">
            <div className="bg-[#89021A] text-white p-2 rounded-xl flex items-center justify-center">
          ...
          <div className="space-y-1">
            <a href="#" className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-[#89021A] text-white font-medium text-sm">
        ...
        <div className="text-xs text-slate-500 bg-slate-800/50 p-3 rounded-xl border border-slate-800">
      ...
      <main className="flex-1 p-6 sm:p-10 max-w-5xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
          ...
          <button
            onClick={fetchFirms}
            className="bg-slate-200 hover:bg-slate-300 text-slate-800 font-semibold text-sm px-4 py-2.5 rounded-xl transition flex items-center gap-2"
          >
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 mb-4 border-b border-slate-100">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="bg-slate-900 hover:bg-[#89021A] text-white text-xs font-semibold px-4 py-2 rounded-xl transition flex items-center gap-1.5"
                    >
        ...
        <button
          ...
          className="w-full py-4 border-2 border-dashed border-slate-300 hover:border-[#89021A] text-slate-600 hover:text-[#89021A] font-semibold rounded-2xl transition flex items-center justify-center gap-2 bg-white"
        >
